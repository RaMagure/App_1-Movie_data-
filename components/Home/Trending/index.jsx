            ...
            <View style={styles.imageContainer}>
              ...
              <ImageBackground
                ...
                <View style={styles.overlay}>
                  ...
                  <Text style={{color:"white",textAlign:"right",fontSize:8}}>Rating: {item.vote_average}</Text>
                  <Text style={{color:"white",textAlign:"right",fontSize:8}}>Votes: {item.vote_count}</Text>
                </View>
              </ImageBackground>
